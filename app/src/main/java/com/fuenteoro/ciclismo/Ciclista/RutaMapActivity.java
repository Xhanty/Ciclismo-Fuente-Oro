...
import com.fuenteoro.ciclismo.Models.RutasUtilidades;
...
public class RutaMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng ruta1 = new LatLng(3.467, -73.617);
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(ruta1, 14));
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        LatLng origen = new LatLng(RutasUtilidades.coordenadas.getLatitud_origen(), RutasUtilidades.coordenadas.getLongitud_origen());
        mMap.addMarker(new MarkerOptions().position(origen).
                title("Lat: "+RutasUtilidades.coordenadas.getLatitud_origen()+" - Long: "+RutasUtilidades.coordenadas.getLongitud_origen())
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.rutamap)));

        LatLng destino = new LatLng(RutasUtilidades.coordenadas.getLatitud_destino(), RutasUtilidades.coordenadas.getLongitud_destino());
        mMap.addMarker(new MarkerOptions().position(destino).title("Lat: "+RutasUtilidades.coordenadas.getLatitud_destino()+" - Long: "+RutasUtilidades.coordenadas.getLongitud_destino()));
    ...
    private void webServiceObtenerRuta(String latitudInicial, String longitudInicial, String latitudFinal, String longitudFinal) {
        ...
        String url="https://maps.googleapis.com/maps/api/directions/json?origin="+latitudInicial+","+longitudInicial
                +"&destination="+latitudFinal+","+longitudFinal+"&key=AIzaSyBKszYgActDQCU2BM2zcoBiwaEzER3-MxQ";
